...
#define PDX(la)		((((uintptr_t) (la)) >> PDXSHIFT) & 0x1FF) //PDXSHIT 21
...
#define PML4(la)  ((((uintptr_t) (la)) >> PML4SHIFT) & 0x1FF) //PML4SHIFT 39

// page table index
#define PTX(la)		((((uintptr_t) (la)) >> PTXSHIFT) & 0x1FF) //PTXSHIFT 12
#define PDPE(la)   ((((uintptr_t) (la)) >> PDPESHIFT) & 0x1FF) //PDPESHIFT 30
